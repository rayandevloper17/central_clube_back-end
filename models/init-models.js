...
// import _score_vote from './score_vote.js'; // MISSING - table doesn't exist
// import _club from './club.js'; // MISSING - table doesn't exist
...
function initModels(sequelize) {
  ...
  // const score_vote = _score_vote(sequelize, DataTypes); // MISSING
  // const club = _club(sequelize, DataTypes); // MISSING
